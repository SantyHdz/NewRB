...
-- Almacenes
INSERT INTO Almacenes (Ubicacion_bodega, Capacidad_bodega) VALUES
                                                               ('Bodega Central, Calle Principal 123', 1500.50),
...
-- Miembros
INSERT INTO Miembros (Nombre, Fecha_registro, Nivel, Puntos) VALUES
                                                                 ('Juan Pérez', '2023-01-15 09:00', 'Oro', 500),
...
-- Empleados
INSERT INTO Empleados (Nombre_empleado, Cargo_empleado, Sueldo, Fecha_contratacion) VALUES
                                                                                        ('Roberto Jiménez', 'Gerente', 4500.00, '2020-01-10 08:00'),
...
-- Peliculas
INSERT INTO Peliculas (Nombre_pelicula, Genero_Pelicula, Fecha_Estreno, Estado_pelicula) VALUES
                                                                                             ('Viaje al Espacio', 'Ciencia Ficción', '2023-01-01 00:00', 1),
...
-- Snacks
INSERT INTO Snacks (Nombre, Precio, Stock) VALUES
                                               ('Palomitas Grandes', 5.99, 200),
...
-- Consolas
INSERT INTO Consolas (Tipo_consola, Marca_consola, Estado_consola, almacen) VALUES
                                                                                ('PlayStation 5', 'Sony', 1, 1),
...
-- Envios
INSERT INTO Envios (Estado, Direccion, Transportadora, empleados) VALUES
                                                                      ('En tránsito', 'Calle 123 #45-67', 'DHL', 1),
...
-- Reservas
INSERT INTO Reservas (Fecha_Reserva, Estado, MiembroId, PeliculaId, ConsolaId, EmpleadoId) VALUES
                                                                                               ('2023-10-01 14:00', 'Activa', 1, 1, NULL, 1),
...
-- Reservas_Snacks
INSERT INTO Reservas_Snacks (SnackId, Reserva) VALUES
                                                   (1, 1),
                                                   (2, 2),
                                                   (3, 3),
                                                   (4, 4),
